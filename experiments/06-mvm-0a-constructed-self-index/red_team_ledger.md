...
***Status: DRAFTED BY THE REVIEWER, AWAITING JOHN. No item below is ruled.
The tier 2 packet (two other-lab models) is built from the target plus these
findings, and nothing is appended to `amendment-a3.md` until both tiers have
filed, John has ruled, and the closure rule is satisfied.***
