...
# Gate B review of the fitted linear read (2026-09-20) — rulings on RT-52 to RT-75
...
`reviews/2026-09-20-fitted-read-claude-worktree.md`. Numbering continues from
RT-51 because the control-learnability review had not filed when this one did —
its packet exists, its findings do not.*

**Rulings below are DRAFTED by the reviewer and are not yet John's.** Nothing
enters STATUS.md until he rules. The three things a ruling has to settle: (1)
...
(`RT-64`), the marker-word target under the fitted read (`RT-71`), and the
standardised refit (`RT-58`).
