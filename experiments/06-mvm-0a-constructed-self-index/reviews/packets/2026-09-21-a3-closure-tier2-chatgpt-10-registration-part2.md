...
===== RECORD 6 of 23, part 2 of 2 - the registration the amendment belongs to, including the loss conditions - COMPLETE FILE: experiments/06-mvm-0a-constructed-self-index/pre-registration.md =====

*This part is from the pre-registered metric and decision rule to the end,
including the loss conditions, the adjudicated decisions and amendments A1 and
A2. The other parts of this record are in file 09.*
